...
\input{Listings.tex} %Code-Listings für JavaScript (ausgelagert in Listings.tex)
...
\input{Entries/1_Einleitung.tex} \newpage

\input{Entries/2_Webseite.tex} \newpage

\input{Entries/3_Testing.tex} \newpage

\input{Entries/4_Kreiserkennung.tex} \newpage

\input{Entries/5_Histogramme.tex} \newpage

\input{Entries/6_TemplateMatching.tex} \newpage

\input{Entries/7_Anpassungen.tex} \newpage

\input{Entries/8_Ergebnisse.tex} \newpage

\input{Entries/9_Fazit.tex} \newpage
