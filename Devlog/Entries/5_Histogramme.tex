...
Wie man sehen kann erstelle ich testweise für jeden Farbkanal ein eigenes Histogramm, um später herauszufinden welcher Kanal am besten geeignet ist. Zusätzlich normalisiere ich alle Histogramme, um "Lücken" in den Histogrammen zu vermeiden. Dafür kann die Funktion \textit{cv.normalize} verwendet werden, welche in meinem Beispiel die Histogramme direkt im Speicher überschreibt.
